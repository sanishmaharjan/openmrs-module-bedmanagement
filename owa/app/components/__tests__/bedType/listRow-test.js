...
import bedTypeFunctionsMock from 'components/__mocks__/bedTypeFunction-mock';
...
describe('BedTypeListRow', () => {
    it('Should render bed Type list properly', () =>{
        const bedTypeListRow = mount(<table><tbody><ListRow bedType={testProps.bedTypeFunctions.getBedTypeById(2)}
    ...
    it('Should trigger event handler', () => {
        ...
        const bedTypeList = mount(<table><tbody><ListRow bedType={testProps.bedTypeFunctions.getBedTypeById(2)}
            bedTypeFunctions={testProps.bedTypeFunctions}/></tbody></table>);
