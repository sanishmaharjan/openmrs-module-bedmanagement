...
describe('BedLayout', () => {
    ...
    it('Should render bed block properly', async () => {
        ...
        const notYesSetBedLayout = shallow(<BedLayout activeUuid='baf83667-d225-11e4-as58-080027b662ec' admissionLocationFunctions={testProps.admissionLocationFunctions}/>);
        await testProps.sleep(100);
        notYesSetBedLayout.update();

        expect(shallowToJson(notYesSetBedLayout)).toMatchSnapshot();
    });
    ...
    it('Should trigger event handler', async () => {
        ...
        const notYesSetBedLayout = mount(<BedLayout activeUuid='baf83667-d225-11e4-as58-080027b662ec'
            admissionLocationFunctions={testProps.admissionLocationFunctions}/>);
        await testProps.sleep(100);
        notYesSetBedLayout.update();

        notYesSetBedLayout.find('label').at(0).simulate('click');
        ...
        notYesSetBedLayout.find('label').at(1).simulate('click');
